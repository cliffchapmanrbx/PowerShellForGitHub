...
<#
    ...
    .PARAMETER GitHubBaseUrl
        The base URL of the GitHub instance to work against. Defaults to 'github.com'. Provide a
        different URL when using this against GitHub Enterprise servers. The server must respond
        to the standard API interface, for instance, api.github.contoso.com.
    .EXAMPLE
    ...
    .EXAMPLE
        ...
        Sets all requests to run against a GitHub Enterprise server running at
